...
// ---------- Seed example ----------
editable.innerHTML = `<h1>Consent Form Title</h1>
<p>Please review the following terms. By proceeding, you consent to the processing of your data.</p>
<ul><li>Example bullet</li><li>Another bullet</li></ul>
<p><strong>Participant:</strong> {{name}}<br><strong>Date:</strong> {{date}}</p>`;
syncAll();
